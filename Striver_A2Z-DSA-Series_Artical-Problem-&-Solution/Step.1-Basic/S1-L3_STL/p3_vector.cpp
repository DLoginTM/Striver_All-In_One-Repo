...
/**
    ...
    the ability to change size whenever elements are added or
    deleted from them.

    Vector elements can be easily accessed and traversed using
    iterators.

    A vector stores elements in contiguous memory locations.

    //------------->Important - most needed
...
int main(){
    ...
    //The front element of the vector
